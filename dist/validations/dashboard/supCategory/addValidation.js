    ...
    validation() {
        return [
            ...
            (0, express_validator_1.check)("metaKeywords_ar")
                ...
                .trim()
                .escape(),
            (0, express_validator_1.check)("mainCatigory")
                .custom((value, { req }) => {
                ...
                .withMessage("enter main category to sup categorys"),
...
exports.AddSupCategoryValidation = AddSupCategoryValidation;
