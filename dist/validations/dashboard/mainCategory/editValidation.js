    ...
    validation() {
        return [
            (0, express_validator_1.check)("category_en")
                ...
                const category = yield categorys_1.default.scope("mainCategorys").findOne({
                    where: {
                        category_en: value,
                        id: {
                            [sequelize_1.Op.ne]: req.params.id,
                        },
                    },
                });
                if (category) {
...
exports.UpdateMainCategoryValidation = UpdateMainCategoryValidation;
