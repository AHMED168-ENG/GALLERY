...
exports.UpdatePersonalDataValidation = void 0;
const express_validator_1 = require("express-validator");
const users_1 = __importDefault(require("../../../models/users"));
const sequelize_1 = require("sequelize");
const config_1 = require("../../../config/config");
class UpdatePersonalDataValidation {
    validation() {
        return [
            ...
            (0, express_validator_1.check)("email")
                ...
                var user = yield users_1.default.findOne({
                    where: {
                        email: value,
                        id: {
                            [sequelize_1.Op.ne]: req.cookies.Admin.id,
                        },
                    },
                });
                if (user) {
...
exports.UpdatePersonalDataValidation = UpdatePersonalDataValidation;
