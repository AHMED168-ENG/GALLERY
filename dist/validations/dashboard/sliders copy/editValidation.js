...
exports.UpdateSliderValidation = void 0;
const express_validator_1 = require("express-validator");
const config_1 = require("../../../config/config");
class UpdateSliderValidation {
    validation() {
        return [
            ...
            (0, express_validator_1.check)("description_en")
                ...
                .trim(),
            (0, express_validator_1.check)("link_ar")
                .notEmpty()
                .withMessage("enter slider link in arabic")
                .trim(),
            (0, express_validator_1.check)("link_en")
                .notEmpty()
                .withMessage("enter slider link in english")
                .trim(),
...
exports.UpdateSliderValidation = UpdateSliderValidation;
